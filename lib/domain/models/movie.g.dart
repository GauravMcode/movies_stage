...
Movie _movieDeserialize(
  ...
  final object = Movie(
    ...
    movieId: reader.readLong(offsets[3]),
...
extension MovieQueryFilter on QueryBuilder<Movie, Movie, QFilterCondition> {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> movieIdEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'movieId',
        value: value,
...
extension MovieQueryProperty on QueryBuilder<Movie, Movie, QQueryProperty> {
  ...
  QueryBuilder<Movie, int, QQueryOperations> movieIdProperty() {
    return QueryBuilder.apply(this, (query) {
